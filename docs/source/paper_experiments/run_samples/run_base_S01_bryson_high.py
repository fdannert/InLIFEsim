...
if __name__ == '__main__':
    ...
    bus.data.options.set_manual(output_filename='S01_base_bryson_hab2high')
    bus.data.options.set_noise_scenario(case='lay')

    # ---------- Loading the Catalog ----------
    bus.data.catalog_from_ppop('/net/ipa-gate/export/ipa/quanz/user_accounts/fdannert/spie_22/10_data/planet_populations_feb23/Brysonhab2high_500uni_PlanetPopulation.txt')
